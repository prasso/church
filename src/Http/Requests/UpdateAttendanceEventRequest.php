...
class UpdateAttendanceEventRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'group_id' => 'nullable|required_without:attendance_group_id|exists:chm_groups,id',
            'attendance_group_id' => 'nullable|required_without:group_id|exists:chm_attendance_groups,id',
